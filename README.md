# Time series with LSTM using Keras on GPU

This repository contains data and a sample notebook to build a simple time series 
model based on LSTM. In order to build and train the model, we're using the 
...
This basically provisions an N-series Ubuntu VM on Azure. The machine has 
